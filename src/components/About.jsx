        ...
        <div>
            <Container id='section2'>
                ...
                <Row style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                    <Col lg={6} md={6} sm={12} style={{paddingBottom: '30px', textAlign:'center'}}><img alt="about" className='borderPicture' style={{borderRadius: '10px', width:'50%', border:'5px solid #fff'}} src='ema.jpeg'/></Col>
